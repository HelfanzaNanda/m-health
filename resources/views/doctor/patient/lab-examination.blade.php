    ...
    <div class="container">
        <div class="col-12 shadow shadow-lg">
            ...
            <div class="row justify-content-center">
                <div class="text-header font-size-18 text-active-pink">Pemeriksaan Lab</div>
            </div>
        </div>
    </div>
    <div class="bg-grey pt-23" style="max-height: 86vh; overflow: auto">
        <div class="container-mhealth ">
            ...
            <div class="nav topnav col-12" role="tablist">
                <a class="font-weight-500 w-50 " href="#physical" data-toggle="tab">Fisik</a>
                <a class="font-weight-500 w-50 active" href="#laboratory" data-toggle="tab">Laboratorium</a>
            </div>

            <h5 class="py-3">Pemeriksaan Lab</h5>
